...
def main(input_str):
    # input_path, hto_array, skip="", extract="", full="", csv="", simplified="", summary="", report="", examine="", output="SSD_mtx", threshold=0.8, ambiguous=0.05):
    ...
    text_output = "==============================GMM-Demux Initialization==============================\n"

    args = parser.parse_args(input_str.split())

    confidence_threshold = args.threshold
    # print("Confidence threshold:", confidence_threshold)
    text_output += "Confidence threshold:"
    text_output += str(confidence_threshold)
    text_output += "\n"
    ...
    if not args.skip:
        ...
        # input_path = '/mnt/c/Users/六/Desktop/GMM-Demux-master/example_input/outs/filtered_feature_bc_matrix'
        hto_array = args.hto_array.split(',')
        # hto_array = 'HTO_1,HTO_2,HTO_3,HTO_4'
        ...
        if args.full:
            ...
            text_output += "Full classification result is stored in"
            text_output += args.full
            text_output += "\n"
        ...
        if args.simplified:
            ...
            text_output += "Simplified classification result is stored in"
            text_output += args.simplified
            text_output += "\n"
        ...
        text_output += "MSM-free droplets are stored in folder"
    ...
    if args.summary:
        ...
        try:
            ...
            text_output += "GMM cannot find a viable solution that satisfies the droplet formation model. SSM rate estimation terminated.\n"
            sys.exit(0)
        ...
        # print("==============================Full Report==============================")
        text_output += "==============================Full Report==============================\n"
        # print(tabulate(full_report_df, headers='keys', tablefmt='psql'))
        text_output += str(tabulate(full_report_df, headers='keys', tablefmt='psql'))
        # print ("\n\n")
        text_output += "\n\n"
        # print("==============================Per Sample Report==============================")
        text_output += "==============================Per Sample Report==============================\n"
        ...
        text_output += str(tabulate(sample_df, headers='keys', tablefmt='psql'))
        text_output += "\n"
        ...
        if args.examine:
            ...
            text_output += "Ambiguous rate:"
            text_output += str(ambiguous_rate)
            ...
            text_output += "\nGEM count: "
            text_output += str(GEM_num)
            text_output += " | MSM count: "
            text_output += str(MSM_num)
            text_output += "\n"
            ...
            text_output += "Phony-type testing. P-value: "
            text_output += str(phony_test_pvalue)
            text_output += "\nPure-type testing. P-value: "
            text_output += str(pure_test_pvalue)
            text_output += "\n"
            ...
            text_output += "Conclusion: The cluster is a"
            text_output += str(cluster_type) 
            text_output += " cluster.\n"
